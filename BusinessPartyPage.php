...
<head>
  ...
  <title>BusinessPartyPage</title>
  <link rel="stylesheet" href="nicepage.css" media="screen">
  <link rel="stylesheet" href="BusinessPartyPage.css" media="screen">
  ...
  <meta property="og:title" content="BusinessPartyPage">
...
<body class="u-body u-xl-mode" data-lang="en">
  <div class="container">
    ...
    if (isset($_POST["submit"])) {
      ...
      $sql = "SELECT * FROM businessguest WHERE email = '$email'";
      ...
      if (count($errors) > 0) {
        ...
        $sql = "INSERT INTO businessguest (fname, lname, email, phone, firstline, secondline, attendee ) VALUES ( ?, ?,
    ?, ?, ?, ?, ? )";
          ...
          <div class="u-layout">
            <div class="u-layout-row">
              <div
                ...
                data-image-width="2499" data-image-height="3748" data-animation-name="customAnimationIn"
              ...
              <div
                ...
                <div class="u-container-layout u-container-layout-2">
                  <h2 class="u-custom-font u-text u-text-palette-5-dark-3 u-text-1"
                    data-animation-name="customAnimationIn" data-animation-duration="1000">Business Party Employee
                    Registration&nbsp;<br>Form
                  </h2>
                  <div class="u-form u-form-1">
                    <form action="BusinessPartyPage.php" method="POST"
                      class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form"
                      style="padding: 28px;">
                      <p class="u-align-center u-custom-font u-form-group u-form-text u-text u-text-2"> "Join us for a
                        night of celebration, networking, and fun at our business party! Save the date!"<br>
                        <br>
                      </p>
                      ...
                      <div class="u-form-group u-form-select u-form-group-8">
                        ...
                        <div class="u-form-select-wrapper">
                          <select id="select-b0cb" name="attendee"
                            ...
                            <option value="One Attendee" name="attendee" data-calc="One Attendee">1</option>
                            <option value="Two Attendee" name="attendee" data-calc="Two Attendee">2</option>
                            <option value="Three Attendee" name="attendee" data-calc="Three Attendee">3</option>
                            <option data-calc="Four Attendee" name="attendee" value="Four Attendee">4</option>
                            <option data-calc="More Than Four Attendee" name="attendee" value="More Than Four Attendee">More Than 4
                            </option>
                          </select>
