...
<head>
  ...
  <link rel="stylesheet" href="Wedreg.css" media="screen">
...
<body class="u-body u-xl-mode" data-lang="en">
  <div class="container">
    ...
    if (isset($_POST['submit'])) {
      ...
      $sql = "SELECT * FROM weddingguest WHERE email = '$email'";
      ...
      if (count($errors) > 0) {
        ...
        $sql = "INSERT INTO weddingguest (fname, lname, email, phone, firstline, secondline, attendee ) VALUES ( ?, ?, ?, ?, ?, ?, ? )";
            ...
            <div class="u-layout-row">
              ...
              <div
                ...
                <div class="u-container-layout u-container-layout-2">
                  <h2 class="u-custom-font u-text u-text-custom-color-10 u-text-1">Wedding Guest Registration Form</h2>
                  <div class="u-form u-form-1">
                    <form action="" method="POST" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form"
                      ...
                      <p class="u-align-center u-custom-font u-form-group u-form-text u-text u-text-2"> "Join us on our
                        special day, witness our love and celebrate as we say 'I do'."</p>
                      ...
                      <div class="u-align-center u-form-group u-form-submit">
                        <input class="btn btn-secondary btn-lg" type="submit" value="Submit" name="submit"
                          class="u-form" />
                        <a href="http://localhost/Guest-Manager-System/ConfirmationPage.php"
                          class="btn btn-secondary btn-lg"> Next</a>
                      </div>
                      <div class="u-form-send-message u-form-send-success"> Thank You ! You have successfully registered
