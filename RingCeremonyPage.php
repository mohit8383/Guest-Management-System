...
<head>
  ...
  <title>RingCeremonyPage</title>
  <link rel="stylesheet" href="nicepage.css" media="screen">
  <link rel="stylesheet" href="RingCeremonyPage.css" media="screen">
  ...
  <link id="u-page-google-font" rel="stylesheet"
    href="https://fonts.googleapis.com/css?family=Aladin:400|Akaya+Kanadaka:400|Allerta+Stencil:400">
  ...
  <meta property="og:title" content="RingCeremonyPage">
...
<body class="u-body u-xl-mode" data-lang="en">
  <div class="container">
    ...
    if (isset($_POST["submit"])) {
      ...
      $sql = "SELECT * FROM ringceremonyguest WHERE email = '$email'";
      ...
      if (count($errors) > 0) {
        ...
        $sql = "INSERT INTO ringceremonyguest (fname, lname, email, phone, firstline, secondline, attendee ) VALUES ( ?, ?, ?, ?, ?, ?, ? )";
        ...
        <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
            <div class="u-layout-row">
              <div
                class="u-container-align-center u-container-style u-image u-image-round u-layout-cell u-radius-38 u-size-22-lg u-size-22-xl u-size-60-md u-size-60-sm u-size-60-xs u-image-1"
                data-image-width="6000" data-image-height="4000" data-animation-name="customAnimationIn"
                data-animation-duration="1000">
                <div class="u-container-layout u-container-layout-1"></div>
              </div>
              <div
                class="u-align-center u-container-style u-layout-cell u-size-38-lg u-size-38-xl u-size-60-md u-size-60-sm u-size-60-xs u-white u-layout-cell-2"
                data-animation-name="customAnimationIn" data-animation-duration="1000">
                <div class="u-container-layout u-container-layout-2">
                  <h2 class="u-custom-font u-text u-text-palette-3-dark-2 u-text-1"
                    data-animation-name="customAnimationIn" data-animation-duration="1000">Ring Ceremony Guest
                    Registration&nbsp;<br>Form
                  </h2>
                  <div class="u-form u-form-1">
                    <form action="RingCeremonyPage.php" method="POST"
                      class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form"
                      style="padding: 28px;">
                      <p class="u-align-center u-custom-font u-form-group u-form-text u-text u-text-2"> "Please join us
                        to
                        witness and celebrate our love as we exchange vows. Save the date!"<br>
                        <br>
                      </p>
                      <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-2">
                        <label for="name-3b6b" class="u-custom-font u-font-georgia u-label u-label-1">First Name</label>
                      ...
                      <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-3">
                        <label for="name-3b6b" class="u-custom-font u-font-georgia u-label u-label-2">Last Name</label>
                      ...
                      <div class="u-form-email u-form-group u-form-group-4">
                        <label for="email-a1f4" class="u-custom-font u-font-georgia u-label u-label-3">Email</label>
                      ...
                      <div class="u-form-group u-form-phone u-form-group-5">
                        <label for="phone-ae91" class="u-custom-font u-font-georgia u-label u-label-4">Phone</label>
                        <input type="tel" placeholder="Enter your Phone No." id="phone-ae91" name="phone"
                      ...
                      <div class="u-form-group u-form-group-6">
                        <label for="text-30f4" class="u-custom-font u-font-georgia u-label u-label-5">Address</label>
                      ...
                      <div class="u-form-group u-form-group-7">
                        <label for="text-cfac"
                          class="u-custom-font u-font-georgia u-form-control-hidden u-label u-label-6"></label>
                        <input type="text" placeholder="Line 2" id="text-cfac" name="secondline"
                          class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-input u-input-rectangle u-none u-input-6">
                      </div>
                      <div class="u-form-group u-form-select u-form-group-8">
                        <label for="select-b0cb" class="u-custom-font u-font-georgia u-label u-label-7">No. of
                          Attendee</label>
                        <div class="u-form-select-wrapper">
                          <select id="select-b0cb" name="select"
                      ...
                      <div class="u-align-center u-form-group u-form-submit">
                        <input type="submit" value="Submit" name="submit" class="u-form btn btn-secondary btn-lg">
                      </div>
