...
<head>
  ...
  <title>WeddingRegistrationPage</title>
  <link rel="stylesheet" href="nicepage.css" media="screen" />
  <link rel="stylesheet" href="../WeddingRegistrationPage.css" media="screen" />
  ...
  <meta property="og:title" content="WeddingRegistrationPage" />
  ...
  <div class="container">
    ...
    if (isset($_POST["submit"])) {
      ...
      if (count($errors) > 0) {
        ...
        $sql = "INSERT INTO form (fname, lname, email, phone, firstline, secondline, attendee ) VALUES ( ?, ?, ?, ?, ?, ?, ? )";
          ...
          <div class="u-layout">
            <div class="u-layout-row">
              <div
                ...
                data-image-width="372" data-image-height="719" data-animation-name="customAnimationIn"
              ...
              <div
                ...
                <div class="u-container-layout u-container-layout-2">
                  <h2 class="u-custom-font u-text u-text-custom-color-10 u-text-1">
                  ...
                  <div class="u-form u-form-1">
                    <form action="wedding.php" method="post"
                      ...
                      style="padding: 28px">
                      <p class="u-align-center u-custom-font u-form-group u-form-text u-text u-text-2">
                        "Join us on our special day, witness our love and
                        celebrate as we say 'I do'."
                      </p>
                      ...
                      <div class="u-form-group u-form-select u-form-group-8">
                        ...
                        <div class="u-form-select-wrapper">
                          <select id="select-b0cb" name="attendee"
                            class="u-border-2 u-border-grey-50 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-none">
                            <option value="One Attendee" data-calc="One Attendee">
                              1
                            </option>
                            <option value="Two Attendee" data-calc="Two Attendee">
                              2
                            </option>
                            <option value="Three Attendee" data-calc="Three Attendee">
                              3
                            </option>
                            <option data-calc="Four Attendee" value="Four Attendee">
                              4
                            </option>
                            <option data-calc="More Than Four Attendee" value="More Than Four Attendee">
                              More Than 4
                            </option>
                          </select>
                      ...
                      <div class="u-align-right u-form-group u-form-submit">
                        <!-- <a href="#"
                          class="u-active-black u-border-active-palette-4-light-1 u-border-hover-palette-4-light-1 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-black u-palette-1-base u-radius-50 u-btn-1">Register
                          Yourself</a> -->
                        <input type="submit" value="Submit" name="submit" class="u-form" />
                      </div>
